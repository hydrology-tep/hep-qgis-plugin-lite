...
class HEPData:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&HEP Data')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'HEPData')
        self.toolbar.setObjectName(u'HEPData')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('HEPData', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/HEPData/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Get HEP Data'),
            callback=self.run,
